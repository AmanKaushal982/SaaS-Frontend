...
const Signup = () => {
  ...
  return (
    <div className='flex justify-center min-h-screen items-center'>
      <form action="" className='shadow-[0_0_1px_rgba(0,0,0,0.5)] border border-gray-400 rounded-2xl w-full sm:w-6/12 h-full p-6 mx-5'>
        ...
        <div className='flex flex-col mb-4'>
          ...
          <input type="text" placeholder='Enter your email address' className='border rounded-lg border-gray-300 py-2 px-2' />
        </div>
        <div className='flex flex-col mb-4 relative'>
          ...
          <input type="text" placeholder='Enter your password' className='border-gray-300 border rounded-lg py-2 px-2' />
          <span className='absolute right-3 translate-y-9 cursor-pointer' onClick={handleChange}>{pwdhide ? <PiEyeBold /> : <PiEyeClosedBold />}  </span>
        </div>
        <button className='bg-black w-full text-white py-2 rounded-lg cursor-pointer mb-4'>Create an account</button>
